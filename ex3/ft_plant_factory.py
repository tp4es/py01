...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/04/14 19:42:12 by tide.oli          #+#    #+#              #
#    Updated: 2026/04/14 19:42:12 by tide.oli         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
class	Plants:
	def	__init__(self, name:str = "default", height:int = 0, age:int = 0):
		...
		self.age = age
	def	show(self):
		print(f"{self.name.capitalize()}: {int(self.height)}cm, {int(self.age)} days old.\n")
